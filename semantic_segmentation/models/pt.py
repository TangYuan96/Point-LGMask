...
class get_model(nn.Module):
    def __init__(self, cls_dim):
        ...
        self.propagation_0_cls = PointNetFeaturePropagation(in_channel=1152 + 3,
    ...
    def load_model_from_ckpt(self, bert_ckpt_path, model_key='pc_msn_target_encoder'):
        if bert_ckpt_path is not None:
            ...
            pring("bert_ckpt_path is not None")
            exit()
