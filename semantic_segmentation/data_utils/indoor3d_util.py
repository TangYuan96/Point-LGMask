...
# DATA_PATH = "/data1/s3dis/Stanford3dDataset_v1.2_Aligned_Version/"
DATA_PATH = "data/S3DIS/S3DIS/Stanford3dDataset_v1.2_Aligned_Version"
# g_classes = [x.rstrip() for x in open(os.path.join(BASE_DIR, 'meta/class_names.txt'))]
g_classes = [x.rstrip() for x in open("/home/pc_msn_61/pc_msn/semantic_segmentation/data_utils/meta/class_names.txt")]
